...
class PanEdgeAnalyse():
    ...
    def reform_weight_adj(self, fold_n, model):
        ...
        kegg_gene_interaction_df = pd.read_csv('../data-nci/filtered_data/kegg_gene_interaction.csv')
        ...
        drug_num_dict_df = pd.read_csv('../data-nci/filtered_data/drug_num_dict.csv')
...
if __name__ == "__main__":
    ...
    build_data = 'data-nci'
    model = build_geowebgnn_model(prog_args, device, build_data)

    # # SET THE FOLD FOR MODEL
    fold_n = 5
    # # dataset = 'oneil'
    dataset = 'nci'
    load_path = '../data-nci/result/epoch_500_fold_5/best_train_model.pt'
